...
class YCSBDB {
	...
	///
	virtual int Read(int id, const std::string &table, const std::string &key,
			 const std::vector<std::string> *fields, std::vector<KVPair> &result) = 0;
	///
	...
	///
	virtual int Scan(int id, const std::string &table, const std::string &key, int record_count,
			 const std::vector<std::string> *fields, std::vector<KVPair> &result) = 0;
	///
	...
	///
	virtual int Update(int id, const std::string &table, const std::string &key, std::vector<KVPair> &values) = 0;
	///
	...
	/// @return Zero on success, a non-zero error code on error.
	///
	virtual int Insert(int id, const std::string &table, const std::string &key, std::vector<KVPair> &values) = 0;
	///
	...
	/// @return Zero on success, a non-zero error code on error.
	///
	//  virtual int Delete(int id, const std::string &table, const std::string &key);
