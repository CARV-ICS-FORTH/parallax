...
class YCSBDB {
 public:
  ...
  ///
  virtual int Scan(int id, const std::string &table, const std::string &key,
  ...
  ///
  virtual int Update(int id, const std::string &table, const std::string &key,
  ...
  /// @return Zero on success, a non-zero error code on error.
  ///
  virtual int Insert(int id, const std::string &table, const std::string &key,
                     std::vector<KVPair> &values) = 0;
  ///
  ...
  /// @return Zero on success, a non-zero error code on error.
  ///
  virtual int Delete(int id, const std::string &table, const std::string &key) = 0;
