...
class DataLoaderFactory(object):
    ...
    def get_loader(type, format_type, dataset_type, epoch):
        ...
        elif type == DataLoaderType.DAOS:
            from dlio_benchmark.data_loader.daos_data_loader import DAOSDataLoader
            return DAOSDataLoader(format_type, dataset_type, epoch)
        elif type == DataLoaderType.PARALLAX:
            from dlio_benchmark.data_loader.parallax_data_loader import ParallaxDataLoader
            return ParallaxDataLoader(format_type, dataset_type, epoch)
        # ... existing imports ...
        else:
            if DLIOMPI.get_instance().rank() == 0:
