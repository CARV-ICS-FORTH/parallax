...
def main():
    ...
    read_sectors_after = 0
    read_sectors_before = 0
    write_sectors_after = 0
    write_sectors_before = 0
    ...
    for y in range(num_of_devices):
        ...
        for x in lines:
            ...
            if tokens[2] == sys.argv[y + 4]:
                read_sectors_before = int(tokens[6])
        ...
        for x in lines:
            ...
            if tokens[2] == sys.argv[y + 4]:
                read_sectors_after = int(tokens[6])
        ...
        for x in lines:
            ...
            if tokens[2] == sys.argv[y + 4]:
                write_sectors_before = int(tokens[10])
        ...
        for x in lines:
            ...
            if tokens[2] == sys.argv[y + 4]:
                write_sectors_after = int(tokens[10])
