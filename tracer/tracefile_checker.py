...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Execute tracer with appropriate parameters")
...
def validate_line(line):
    ...
    if(op == Op.PUT):
        ...
        print(colors.RED + "Invalid operation: " + str_line_list[0] + " in tracefile" + colors.ENDC)
        print("Exiting..")
        sys.exit(1)
