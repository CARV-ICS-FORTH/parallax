...
def options(flag, confh):
        tosearch = ["#define LEVEL0_TOTAL_SIZE", "#define INSERT_TO_INDEX ",
                    "#define NUMBER_OF_DATABASES ", "#define ZERO_LEVEL_MEMORY_SPILL_THREASHOLD"]

        tobereplaced = ["#define LEVEL0_TOTAL_SIZE GB(2)\n", "#define INSERT_TO_INDEX 1\n", "#define NUMBER_OF_DATABASES (4)\n",
...
def main():
        ...
        confh = open("conf.h", "r+")  # Initial conf.h that will be changed to meet the tests requirements
