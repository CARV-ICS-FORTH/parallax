...
hosts = ["tie4.cluster.ics.forth.gr-8080 ", "tie4.cluster.ics.forth.gr-8081"]


print("0 -oo 04000 tie4.cluster.ics.forth.gr-8080 tie4.cluster.ics.forth.gr-8081")
region_id = 1
idx = 0
min = 4000
...
print(
    str(region_id) + "  " + " " + str(min) + "  +oo" + " " + hosts[idx] + " " + hosts[1]
)
